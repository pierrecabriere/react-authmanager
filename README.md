...
You need to configure before starting to use the toolkit, so your highest component is the best place to configure (by example, it's the `App.js` file with a [create-react-app](https://github.com/facebook/create-react-app) instance !)
```js
